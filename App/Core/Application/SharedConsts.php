...
class SharedConsts{
	...
	public const MYSQL_ERR_DUPLICATE_ENTRY = 1062;
	public const MYSQL_ERR_FOREIGN_KEY_CONSTRAINT = 1452;
	public const MYSQL_INCORRECT_FORMAT = 1292;
	public const MYSQL_INCORRECT_TYPE = 1366;
